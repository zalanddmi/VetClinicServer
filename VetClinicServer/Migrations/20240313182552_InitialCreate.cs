        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Breed = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentDrugs", x => new { x.AppointmentId, x.DrugId });
                    table.ForeignKey(
                        name: "FK_AppointmentDrugs_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentDrugs_Drugs_DrugId",
                        column: x => x.DrugId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentDrugs_DrugId",
                table: "AppointmentDrugs",
                column: "DrugId");
